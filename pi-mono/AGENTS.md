...
## Testing swarmz Interactive Mode with tmux

To test swarmz's TUI in a controlled terminal environment:

```bash
# Create tmux session with specific dimensions
tmux new-session -d -s swarmz-test -x 80 -y 24

# Start swarmz from source
tmux send-keys -t swarmz-test "cd /Users/badlogic/workspaces/swarmz && ./swarmz-test.sh" Enter

# Wait for startup, then capture output
sleep 3 && tmux capture-pane -t swarmz-test -p

# Send input
tmux send-keys -t swarmz-test "your prompt here" Enter

# Send special keys
tmux send-keys -t swarmz-test Escape
tmux send-keys -t swarmz-test C-o  # ctrl+o

# Cleanup
tmux kill-session -t swarmz-test
```
...
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/badlogic/swarmz/issues/123))`
- **External contributions**: `Added feature X ([#456](https://github.com/badlogic/swarmz/pull/456) by [@username](https://github.com/username))`
