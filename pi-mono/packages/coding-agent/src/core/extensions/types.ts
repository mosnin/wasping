...
import type {
	...
	ThinkingLevel,
	ToolExecutionMode,
} from "@mariozechner/swarmz-agent-core";
import type {
	Api,
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@mariozechner/swarmz-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@mariozechner/swarmz-coding-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown swarmz and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Swarmz loaded without re-discovering resources. */
...
/** Configuration for registering a provider via swarmz.registerProvider(). */
...
export type ExtensionFactory = (swarmz: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for swarmz.* API methods.
