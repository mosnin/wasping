...
import type { AssistantMessage, ImageContent, Message, Model, TextContent } from "@mariozechner/swarmz-ai";
import {
	clampThinkingLevel,
...
export class AgentSession {
	 ...
	 * - Handles extension commands (registered via swarmz.registerCommand) immediately, even during streaming
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via swarmz.sendMessage()
