    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="swarmz-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="swarmz-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'swarmz-share:v1:sidebar-width';
