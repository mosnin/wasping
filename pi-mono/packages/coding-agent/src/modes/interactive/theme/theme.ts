...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@midhaven/swarmz-tui";
...
const THEME_KEY = Symbol.for("@midhaven/swarmz-coding-agent:theme");
...
export function getSettingsListTheme(): import("@midhaven/swarmz-tui").SettingsListTheme {
	return {
