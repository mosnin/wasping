...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@mariozechner/swarmz-tui";
...
const THEME_KEY = Symbol.for("@mariozechner/swarmz-coding-agent:theme");
...
export function getSettingsListTheme(): import("@mariozechner/swarmz-tui").SettingsListTheme {
	return {
