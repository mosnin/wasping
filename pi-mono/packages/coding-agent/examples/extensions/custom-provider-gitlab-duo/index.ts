 ...
 * Delegates to swarmz-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   swarmz -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (swarmz: ExtensionAPI) {
	swarmz.registerProvider("gitlab-duo", {
