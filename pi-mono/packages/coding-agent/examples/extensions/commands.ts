 ...
 * Commands Extension
 *
 * Demonstrates the swarmz.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@mariozechner/swarmz-coding-agent";

export default function commandsExtension(swarmz: ExtensionAPI) {
	swarmz.registerCommand("commands", {
