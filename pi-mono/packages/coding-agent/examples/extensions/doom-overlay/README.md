...
Play DOOM as an overlay in swarmz. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
swarmz --extension ./examples/extensions/doom-overlay
```
...
- [swarmz-doom](https://github.com/badlogic/pi-mono-doom) for the original swarmz integration
