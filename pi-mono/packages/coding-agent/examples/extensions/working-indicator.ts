 ...
 * working indicator shown while swarmz is streaming a response.
 *
 * Usage:
 *   swarmz --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore swarmz's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@mariozechner/swarmz-coding-agent";
...
export default function (swarmz: ExtensionAPI) {
	...
	swarmz.registerCommand("working-indicator", {
