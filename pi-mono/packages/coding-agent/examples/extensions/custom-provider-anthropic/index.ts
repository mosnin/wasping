 ...
 *   swarmz -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... swarmz -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (swarmz: ExtensionAPI) {
	swarmz.registerProvider("custom-anthropic", {
