> swarmz can create prompt templates. Ask it to build one for your workflow.
...
Swarmz loads prompt templates from:

- Global: `~/.swarmz/agent/prompts/*.md`
- Project: `.swarmz/prompts/*.md`
- Packages: `prompts/` directories or `swarmz.prompts` entries in `package.json`
