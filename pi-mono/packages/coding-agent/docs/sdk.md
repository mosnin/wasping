...
```bash
npm install @mariozechner/swarmz-coding-agent
```
...
The `Agent` class (from `@mariozechner/swarmz-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@mariozechner/swarmz-ai";
import { AuthStorage, ModelRegistry } from "@mariozechner/swarmz-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@mariozechner/swarmz-coding-agent";
...
import { createAgentSession, defineTool } from "@mariozechner/swarmz-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@mariozechner/swarmz-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@mariozechner/swarmz-coding-agent";
