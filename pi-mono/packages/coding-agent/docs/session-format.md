...
Source on GitHub ([swarmz](https://github.com/badlogic/pi-mono)):
...
For TypeScript definitions in your project, inspect `node_modules/@midhaven/swarmz-coding-agent/dist/` and `node_modules/@midhaven/swarmz-ai/dist/`.
