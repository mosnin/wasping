...
**Source files** ([swarmz](https://github.com/badlogic/pi-mono)):
...
For TypeScript definitions in your project, inspect `node_modules/@midhaven/swarmz-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@midhaven/swarmz-coding-agent";
