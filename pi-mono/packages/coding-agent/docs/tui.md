...
**Source:** [`@midhaven/swarmz-tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@midhaven/swarmz-tui";
...
```typescript
import { Container, type Focusable, Input } from "@midhaven/swarmz-tui";
...
Import from `@midhaven/swarmz-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@midhaven/swarmz-tui";
```
...
```typescript
import { matchesKey, Key } from "@midhaven/swarmz-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@midhaven/swarmz-tui";
...
```typescript
import { getMarkdownTheme } from "@midhaven/swarmz-coding-agent";
import { Markdown } from "@midhaven/swarmz-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@midhaven/swarmz-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@midhaven/swarmz-coding-agent";
import { DynamicBorder } from "@midhaven/swarmz-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@midhaven/swarmz-tui";
...
```typescript
import { BorderedLoader } from "@midhaven/swarmz-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@midhaven/swarmz-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@midhaven/swarmz-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@midhaven/swarmz-tui";
...
import { matchesKey, truncateToWidth } from "@midhaven/swarmz-tui";
