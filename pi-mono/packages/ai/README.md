...
```bash
npm install @mariozechner/swarmz-ai
```

TypeBox exports are re-exported from `@mariozechner/swarmz-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@mariozechner/swarmz-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@mariozechner/swarmz-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@mariozechner/swarmz-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@mariozechner/swarmz-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@mariozechner/swarmz-ai';
...
```typescript
import { getModel, stream } from '@mariozechner/swarmz-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@mariozechner/swarmz-ai';
...
```typescript
import { Model, stream } from '@mariozechner/swarmz-ai';
...
Use model-level `thinkingLevelMap` to describe model-specific thinking controls. Keys are swarmz thinking levels (`off`, `minimal`, `low`, `medium`, `high`, `xhigh`). Missing keys use provider defaults, string values are sent to the provider, and `null` marks a level unsupported.
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@mariozechner/swarmz-ai';
...
```typescript
import { getModel, complete, Context } from '@mariozechner/swarmz-ai';
...
```typescript
import { Context, getModel, complete } from '@mariozechner/swarmz-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@mariozechner/swarmz-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@mariozechner/swarmz-ai';
...
```bash
npx @mariozechner/swarmz-ai login              # interactive provider selection
npx @mariozechner/swarmz-ai login anthropic    # login to specific provider
npx @mariozechner/swarmz-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@mariozechner/swarmz-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@mariozechner/swarmz-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@mariozechner/swarmz-ai/oauth';
...
```typescript
import { getModel, complete } from '@mariozechner/swarmz-ai';
import { getOAuthApiKey } from '@mariozechner/swarmz-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@mariozechner/swarmz-ai`
