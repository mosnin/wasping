...
```bash
npm install @midhaven/swarmz-ai
```

TypeBox exports are re-exported from `@midhaven/swarmz-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@midhaven/swarmz-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@midhaven/swarmz-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@midhaven/swarmz-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@midhaven/swarmz-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@midhaven/swarmz-ai';
...
```typescript
import { getModel, stream } from '@midhaven/swarmz-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@midhaven/swarmz-ai';
...
```typescript
import { Model, stream } from '@midhaven/swarmz-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@midhaven/swarmz-ai';
...
```typescript
import { getModel, complete, Context } from '@midhaven/swarmz-ai';
...
```typescript
import { Context, getModel, complete } from '@midhaven/swarmz-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@midhaven/swarmz-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@midhaven/swarmz-ai';
...
```bash
npx @midhaven/swarmz-ai login              # interactive provider selection
npx @midhaven/swarmz-ai login anthropic    # login to specific provider
npx @midhaven/swarmz-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@midhaven/swarmz-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@midhaven/swarmz-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@midhaven/swarmz-ai/oauth';
...
```typescript
import { getModel, complete } from '@midhaven/swarmz-ai';
import { getOAuthApiKey } from '@midhaven/swarmz-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@midhaven/swarmz-ai`
