# @midhaven/swarmz-web-ui

Reusable web UI components for building AI chat interfaces powered by [@midhaven/swarmz-ai](../ai) and [@midhaven/swarmz-agent-core](../agent).
...
```bash
npm install @midhaven/swarmz-web-ui @midhaven/swarmz-agent-core @midhaven/swarmz-ai
```
...
```typescript
import { Agent } from '@midhaven/swarmz-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@midhaven/swarmz-web-ui';
import '@midhaven/swarmz-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@midhaven/swarmz-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@midhaven/swarmz-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@midhaven/swarmz-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@midhaven/swarmz-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@midhaven/swarmz-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@midhaven/swarmz-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@midhaven/swarmz-web-ui';
...
```typescript
import { SessionListDialog } from '@midhaven/swarmz-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@midhaven/swarmz-web-ui';
...
```typescript
import { ModelSelector } from '@midhaven/swarmz-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@midhaven/swarmz-web-ui';
