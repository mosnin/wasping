# @mariozechner/swarmz-web-ui

Reusable web UI components for building AI chat interfaces powered by [@mariozechner/swarmz-ai](../ai) and [@mariozechner/swarmz-agent-core](../agent).
...
```bash
npm install @mariozechner/swarmz-web-ui @mariozechner/swarmz-agent-core @mariozechner/swarmz-ai
```
...
```typescript
import { Agent } from '@mariozechner/swarmz-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@mariozechner/swarmz-web-ui';
import '@mariozechner/swarmz-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { SessionListDialog } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { ModelSelector } from '@mariozechner/swarmz-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@mariozechner/swarmz-web-ui';
...
- [sitegeist](https://sitegeist.ai) - Browser extension using swarmz-web-ui
