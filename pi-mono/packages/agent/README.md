# @midhaven/swarmz-agent-core

Stateful agent with tool execution and event streaming. Built on `@midhaven/swarmz-ai`.

## Installation

```bash
npm install @midhaven/swarmz-agent-core
```
...
```typescript
import { Agent, streamProxy } from "@midhaven/swarmz-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@midhaven/swarmz-agent-core";
