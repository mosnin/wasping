...
- **Agent loop moved from `@midhaven/swarmz-ai`**: The `agentLoop`, `agentLoopContinue`, and related types have moved to this package. Import from `@midhaven/swarmz-agent-core` instead.
